#!/usr/bin/env python
"""
Simplified example of asset-specific signal selection.

This script demonstrates the core functionality of selecting and evaluating
signals for specific assets without dynamic imports.
"""
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler('simple_asset_specific_signals.log')
        ]
    )
...
def main():
    ...
    setup_logging()
    logger = logging.getLogger(__name__)
    logger.info("Starting simple asset-specific signals example")
    ...
    logger.info("Simple asset-specific signals example completed")
