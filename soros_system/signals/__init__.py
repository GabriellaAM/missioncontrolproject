...
from . import trend_momentum_signals  # Import the new Trend Momentum signals module
...
from .trend_momentum_signals import (  # Import the Trend Momentum signals
    TrendMomentumUSD, TrendMomentumBTC,
)
